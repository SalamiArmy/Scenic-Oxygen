...
class TestRemove(unittest.TestCase):
    ...
    def test_remove(self):
        ...
        self.assertEquals(main.load_command_module('retry_on_telegram_error'), None)
        self.assertEquals(main.load_command_module('get'), None)
        self.assertEquals(main.load_command_module('getgif'), None)
