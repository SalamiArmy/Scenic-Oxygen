...
class TestDiscordPost(unittest.TestCase):
    ...
    def integration_test_discord_post(self):
        newRequestObject = main.DiscordWebhookHandler()
        class Object(object):
            pass
    ...
    def integration_test_set_discord_webhook(self):
        newRequestObject = main.SetDiscordWebhookHandler()
        class Object(object):
            pass
        newRequestObject.request = Object()
        newRequestObject.request.body = '{"message": {"from": {"username": "SalamiArmy", "first_name": "Ashley", "last_name": "Lewis"}, "text": "/getgif grade A 👌👌 100% 👌👌 good shit", "chat": {"id": -55348600, "type": "group"}}}'
